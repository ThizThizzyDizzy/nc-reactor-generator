...
import net.ncplanner.plannerator.discord.play.smivilization.thing.Lamp;
import net.ncplanner.plannerator.discord.play.smivilization.thing.LightSwitch;
import net.ncplanner.plannerator.discord.play.smivilization.thing.PuLaptop;
import net.ncplanner.plannerator.discord.play.smivilization.thing.PurpleTriflorice;
import net.ncplanner.plannerator.discord.play.smivilization.thing.Shelf;
import net.ncplanner.plannerator.discord.play.smivilization.thing.SmoreRug;
import net.ncplanner.plannerator.discord.play.smivilization.thing.SpaceBed;
import net.ncplanner.plannerator.discord.play.smivilization.thing.SpaceLamp;
import net.ncplanner.plannerator.discord.play.smivilization.thing.SpaceShelf;
import net.ncplanner.plannerator.discord.play.smivilization.thing.SpaceTable;
import net.ncplanner.plannerator.discord.play.smivilization.thing.Table;
import net.ncplanner.plannerator.discord.play.smivilization.thing.Television;
import net.ncplanner.plannerator.discord.play.smivilization.thing.TelevisionRemote;
import net.ncplanner.plannerator.discord.play.smivilization.thing.TomPainting;
import net.ncplanner.plannerator.discord.play.smivilization.thing.TropicalBed;
import net.ncplanner.plannerator.discord.play.smivilization.thing.TropicalShelf;
import net.ncplanner.plannerator.discord.play.smivilization.thing.TropicalTable;
import net.ncplanner.plannerator.discord.play.smivilization.thing.WastelandBed;
import net.ncplanner.plannerator.discord.play.smivilization.thing.WastelandShelf;
import net.ncplanner.plannerator.discord.play.smivilization.thing.WastelandTable;
import net.ncplanner.plannerator.discord.play.smivilization.thing.special.EatenSmoreTrophy;
