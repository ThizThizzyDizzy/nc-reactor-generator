...
public class SiezureTheme extends ColorTheme{
    ...
    public Color getCodeBackgroundColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeBackgroundColor();
        return rand();
    }
    @Override
    public Color getCodeTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeTextColor();
        return rand();
    }
    @Override
    ...
    public Color getCodeOperatorTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeOperatorTextColor();
        return rand();
    }
    @Override
    public Color getCodeBooleanTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeBooleanTextColor();
        return rand();
    }
    @Override
    public Color getCodeCharTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeCharTextColor();
        return rand();
    }
    @Override
    public Color getCodeCommentTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeCommentTextColor();
        return rand();
    }
    @Override
    public Color getCodeFloatTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeFloatTextColor();
        return rand();
    }
    @Override
    public Color getCodeIntTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeIntTextColor();
        return rand();
    }
    @Override
    public Color getCodeLabelTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeLabelTextColor();
        return rand();
    }
    @Override
    public Color getCodeStringTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeStringTextColor();
        return rand();
    }
    @Override
    public Color getCodeIdentifierTextColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeIdentifierTextColor();
        return rand();
    }
    @Override
    ...
    public Color getCodeLineMarkerColor(){
        if(!Objects.equals(siezureAllowed, Boolean.TRUE))return Theme.STANDARD.getCodeLineMarkerColor();
        return rand();
    }
    @Override
