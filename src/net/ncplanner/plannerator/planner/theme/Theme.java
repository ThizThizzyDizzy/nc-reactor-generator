...
public abstract class Theme{
    ...
    static{
        ...
        addTheme(new SolidColorTheme("Unobtanium", new Color(82, 48, 219)));
    ...
    public abstract Color getValidatorWarningTextColor();
    ...
    public abstract Color getCodeCommentTextColor();
    public abstract Color getCodeFloatTextColor();
    public abstract Color getCodeIntTextColor();
    public abstract Color getCodeLabelTextColor();
