...
public class RandomColorsTheme extends ColorTheme{
    ...
    public Color codeCommentTextColor;
    public Color codeFloatTextColor;
    public Color codeIntTextColor;
    public Color codeLabelTextColor;
    ...
    public Color getCodeBackgroundColor(){
        return codeBackgroundColor = gen(codeBackgroundColor);
    }
    @Override
    ...
    public Color getCodeOperatorTextColor(){
        return codeOperatorTextColor = gen(codeOperatorTextColor);
    }
    @Override
    public Color getCodeBooleanTextColor(){
        return codeBooleanTextColor = gen(codeBooleanTextColor);
    }
    @Override
    public Color getCodeCharTextColor(){
        return codeCharTextColor = gen(codeCharTextColor);
    }
    @Override
    public Color getCodeCommentTextColor(){
        return codeCommentTextColor = gen(codeCommentTextColor);
    }
    @Override
    public Color getCodeFloatTextColor(){
        return codeFloatTextColor = gen(codeFloatTextColor);
    }
    @Override
    public Color getCodeIntTextColor(){
        return codeIntTextColor = gen(codeIntTextColor);
    }
    @Override
    public Color getCodeLabelTextColor(){
        return codeLabelTextColor = gen(codeLabelTextColor);
    }
    @Override
    public Color getCodeStringTextColor(){
        return codeStringTextColor = gen(codeStringTextColor);
    }
    @Override
    public Color getCodeIdentifierTextColor(){
        return codeIdentifierTextColor = gen(codeIdentifierTextColor);
    }
    @Override
    ...
    public Color getCodeLineMarkerColor(){
        return codeLineMarkerColor = gen(codeLineMarkerColor);
    }
    @Override
