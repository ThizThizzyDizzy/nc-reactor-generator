...
public class ChangingTheme extends Theme{
    ...
    public Color getCodeBackgroundColor(){
        return current.getCodeBackgroundColor();
    }
    @Override
    ...
    public Color getCodeOperatorTextColor(){
        return current.getCodeOperatorTextColor();
    }
    @Override
    public Color getCodeBooleanTextColor(){
        return current.getCodeBooleanTextColor();
    }
    @Override
    public Color getCodeCharTextColor(){
        return current.getCodeCharTextColor();
    }
    @Override
    public Color getCodeCommentTextColor(){
        return current.getCodeCommentTextColor();
    }
    @Override
    public Color getCodeFloatTextColor(){
        return current.getCodeFloatTextColor();
    }
    @Override
    public Color getCodeIntTextColor(){
        return current.getCodeIntTextColor();
    }
    @Override
    public Color getCodeLabelTextColor(){
        return current.getCodeLabelTextColor();
    }
    @Override
    public Color getCodeStringTextColor(){
        return current.getCodeStringTextColor();
    }
    @Override
    public Color getCodeIdentifierTextColor(){
        return current.getCodeIdentifierTextColor();
    }
    @Override
    ...
    public Color getCodeLineMarkerColor(){
        return current.getCodeLineMarkerColor();
    }
    @Override
