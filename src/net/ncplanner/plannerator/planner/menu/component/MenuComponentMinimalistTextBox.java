    ...
    public void render(){
        ...
        if(editable){
            if(title!=null){
                ...
                drawText(x+textInset, MathUtil.getValueBetweenTwoValues(1, y+textInset, 0, y+height-textInset-titleInset, actualTitleness), x+width-textInset, MathUtil.getValueBetweenTwoValues(1, y+height-textInset-titleInset, 0, y+height-textInset, actualTitleness), title);
