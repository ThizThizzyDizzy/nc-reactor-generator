...
import net.ncplanner.plannerator.planner.menu.component.MenuComponentDropdownList;
...
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentCoolantRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentEditorGrid;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentEditorListBlock;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentEditorTool;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentFusionCoolantRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentMultiblockProgressBar;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentOverhaulFusionBlockRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentOverhaulFusionRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentOverhaulMSRBlockRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentOverhaulSFRBlockRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentSuggestion;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentSuggestor;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentTurbineRecipe;
import net.ncplanner.plannerator.planner.menu.component.editor.MenuComponentUnderFuel;
...
public class MenuEdit extends Menu implements Editor, DebugInfoProvider{
    ...
    private final MenuComponentMinimalistButton undo = add(new MenuComponentMinimalistButton(0, 0, 0, 0, "Undo", false, true){
        ...
        public void drawText(){
            ...
            renderer.drawRegularPolygon(x+width/4, y+height*.5625, width/4, 3, -5, 0);
        }
    ...
    private final MenuComponentMinimalistButton redo = add(new MenuComponentMinimalistButton(0, 0, 0, 0, "Redo", false, true){
        ...
        public void drawText(){
            ...
            renderer.drawRegularPolygon(x+width*3/4, y+height*.5625, width/4, 3, 5, 0);
        }
    ...
    public void draw3D(){
        ...
        for(MenuComponent comp : multibwauk.components){
            if(comp instanceof MenuComponentEditorGrid){
                ...
                renderer.drawCube(X+blockSize/2, Y-border/2, Z-border/2, bbox.getWidth()*blockSize, Y+border/2, Z+border/2, 0);//PX
                renderer.drawCube(X-border/2, Y+blockSize/2, Z-border/2, X+border/2, bbox.getHeight()*blockSize, Z+border/2, 0);//PY
                renderer.drawCube(X-border/2, Y-border/2, Z+blockSize/2, X+border/2, Y+border/2, bbox.getDepth()*blockSize, 0);//PZ
            }
        }
        ...
        for(EditorSpace space : ((Multiblock<Block>)multiblock).getEditorSpaces()){
            getSelectedTool(0).drawVRGhosts(renderer, space, 0, 0, 0, 1, 1, 1, blockSize, (getSelectedBlock(0)==null?0:Core.getTexture(getSelectedBlock(0).getTexture())));
        }
    }
    @Override
