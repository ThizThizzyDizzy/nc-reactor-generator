                ...
                if(underhaul.fissionSFR==null){
                    ...
                    for(int i = 0; i<sfr.blocks.size(); i++){
                        ...
                        Runnable blockConfig = () -> {
                            gui.open(new net.ncplanner.plannerator.planner.menu.configuration.underhaul.fissionsfr.MenuBlockConfiguration(gui, this, configuration, b));
                        };
                    ...
                    for(int i = 0; i<sfr.fuels.size(); i++){
                        ...
                        Runnable fuelConfig = () -> {
                            gui.open(new net.ncplanner.plannerator.planner.menu.configuration.underhaul.fissionsfr.MenuFuelConfiguration(gui, this, configuration, f));
                        };
                        //<editor-fold defaultstate="collapsed" desc="Name">
                        if(f.name==null){
                ...
                if(overhaul.fissionSFR==null&&overhaul.fissionMSR==null&&overhaul.turbine==null&&overhaul.fusion==null){
                    ...
                    if(overhaul.fissionSFR!=null){
                        ...
                        for(int i = 0; i<sfr.blocks.size(); i++){
                            ...
                            Runnable blockConfig = () -> {
                                gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.fissionsfr.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                            ...
                            for(net.ncplanner.plannerator.multiblock.configuration.overhaul.fissionsfr.BlockRecipe br : b.recipes){
                                Runnable blockRecipeConfig = () -> {
                                    gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.fissionsfr.MenuBlockRecipeConfiguration(gui, this, configuration, b, br));
                                };
                        ...
                        for(int i = 0; i<sfr.coolantRecipes.size(); i++){
                            ...
                            Runnable coolantRecipeConfig = () -> {
                                gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.fissionsfr.MenuCoolantRecipeConfiguration(gui, this, configuration, c));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Input Name">
                            if(c.inputName==null){
                    ...
                    if(overhaul.fissionMSR!=null){
                        ...
                        for(int i = 0; i<msr.blocks.size(); i++){
                            ...
                            Runnable blockConfig = () -> {
                                gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.fissionmsr.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                            ...
                            if(b.irradiator){
                                ...
                                for(net.ncplanner.plannerator.multiblock.configuration.overhaul.fissionmsr.BlockRecipe br : b.recipes){
                                    Runnable blockRecipeConfig = () -> {
                                        gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.fissionmsr.MenuBlockRecipeConfiguration(gui, this, configuration, b, br));
                                    };
                                    //<editor-fold defaultstate="collapsed" desc="Input Name">
                                    if(br.inputName==null){
                    ...
                    if(overhaul.turbine!=null){
                        ...
                        for(int i = 0; i<turbine.blocks.size(); i++){
                            ...
                            Runnable blockConfig = () -> {
                                gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.turbine.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                        ...
                        for(int i = 0; i<turbine.recipes.size(); i++){
                            ...
                            Runnable recipeConfig = () -> {
                                gui.open(new net.ncplanner.plannerator.planner.menu.configuration.overhaul.turbine.MenuRecipeConfiguration(gui, this, configuration, c));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Input Name">
                            if(c.inputName==null){
