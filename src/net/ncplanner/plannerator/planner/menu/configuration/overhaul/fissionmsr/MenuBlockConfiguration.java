...
import net.ncplanner.plannerator.multiblock.configuration.overhaul.fissionmsr.PlacementRule;
    ...
    public MenuBlockConfiguration(GUI gui, Menu parent, Configuration configuration, Block block){
        ...
        addList(()->{return "Placement Rules ("+block.rules.size()+")";}, "New Rule", ()->{
            ...
            gui.open(new MenuPlacementRuleConfiguration(
                    ...
                    net.ncplanner.plannerator.multiblock.configuration.overhaul.fissionmsr.PlacementRule.BlockType.values()
            ));
        }, (list)->{
