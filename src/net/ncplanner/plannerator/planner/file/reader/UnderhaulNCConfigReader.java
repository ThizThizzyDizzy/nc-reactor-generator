...
public class UnderhaulNCConfigReader implements FormatReader{
    ...
    public synchronized Project read(Supplier<InputStream> in, RecoveryHandler recovery){
        ...
        BlockElement redstone = builder.cooler("nuclearcraft:cooler:2", "Redstone Cooler", (int)coolingRates.getDouble(1), "underhaul/redstone", builder.atLeast(1, FuelCellModule::new));
        BlockElement quartz = builder.cooler("nuclearcraft:cooler:3", "Quartz Cooler", (int)coolingRates.getDouble(2), "underhaul/quartz", builder.atLeast(1, ModeratorModule::new));
        BlockElement gold = builder.cooler("nuclearcraft:cooler:4", "Gold Cooler", (int)coolingRates.getDouble(3), "underhaul/gold", builder.atLeast(1, water), builder.atLeast(1, redstone));
        BlockElement glowstone = builder.cooler("nuclearcraft:cooler:5", "Glowstone Cooler", (int)coolingRates.getDouble(4), "underhaul/glowstone", builder.atLeast(2, ModeratorModule::new));
        ...
        BlockElement emerald = builder.cooler("nuclearcraft:cooler:12", "Emerald Cooler", (int)coolingRates.getDouble(11), "underhaul/emerald", builder.atLeast(1, ModeratorModule::new), builder.atLeast(1, FuelCellModule::new));
        BlockElement copper = builder.cooler("nuclearcraft:cooler:13", "Copper Cooler", (int)coolingRates.getDouble(12), "underhaul/copper", builder.atLeast(1, glowstone));
        BlockElement tin = builder.cooler("nuclearcraft:cooler:14", "Tin Cooler", (int)coolingRates.getDouble(13), "underhaul/tin", builder.axis(lapis));
        BlockElement magnesium = builder.cooler("nuclearcraft:cooler:15", "Magnesium Cooler", (int)coolingRates.getDouble(14), "underhaul/magnesium", builder.atLeast(1, CasingModule::new), builder.atLeast(1, ModeratorModule::new));
