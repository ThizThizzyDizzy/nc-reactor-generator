...
public class UnderhaulNCConfigReader implements FormatReader{
    ...
    public synchronized Project read(Supplier<InputStream> in, RecoveryHandler recovery){
        ...
        builder.activeRecipe((int)activeCoolingRates.getDouble(0), "water", "Water", builder.or(builder.atLeast(1, FuelCellModule::new), builder.atLeast(1, ModeratorModule::new))).texture("fluids/water").legacy("Water").legacy("Active Water");
        builder.activeRecipe((int)activeCoolingRates.getDouble(1), "redstone", "Molten Redstone", builder.atLeast(1, FuelCellModule::new)).texture(TextureManager.MOLTEN, 0xAB1C09).legacy("Destabilized Redstone").legacy("Active Redstone");
        builder.activeRecipe((int)activeCoolingRates.getDouble(2), "quartz", "Molten Quartz", builder.atLeast(1, ModeratorModule::new)).texture(TextureManager.MOLTEN, 0xECE9E2).legacy("Molten Quartz").legacy("Active Quartz");
        builder.activeRecipe((int)activeCoolingRates.getDouble(3), "gold", "Molten Gold", builder.atLeast(1, water), builder.atLeast(1, redstone)).texture(TextureManager.MOLTEN, 0xE6DA3C).legacy("Molten Gold").legacy("Active Gold");
        builder.activeRecipe((int)activeCoolingRates.getDouble(4), "glowstone", "Molten Glowstone", builder.atLeast(2, ModeratorModule::new)).texture(TextureManager.MOLTEN, 0xA38037).legacy("Energized Glowstone").legacy("Active Glowstone");
        builder.activeRecipe((int)activeCoolingRates.getDouble(5), "lapis", "Molten Lapis", builder.atLeast(1, FuelCellModule::new),builder.atLeast(1, CasingModule::new)).texture(TextureManager.MOLTEN, 0x27438A).legacy("Molten Lapis").legacy("Active Lapis");
        builder.activeRecipe((int)activeCoolingRates.getDouble(6), "diamond", "Molten Diamond", builder.atLeast(1, water), builder.atLeast(1, quartz)).texture(TextureManager.MOLTEN, 0x6FDFDA).legacy("Molten Diamond").legacy("Active Diamond");
        builder.activeRecipe((int)activeCoolingRates.getDouble(7), "liquidhelium", "Liquid Helium", builder.exactly(1, redstone), builder.atLeast(1, CasingModule::new)).texture("fluids/liquidhelium").legacy("Liquid Helium").legacy("Active Helium");
        builder.activeRecipe((int)activeCoolingRates.getDouble(8), "ender", "Molten Ender", builder.and(builder.exactly(3, CasingModule::new),builder.vertex(CasingModule::new))).texture(TextureManager.MOLTEN, 0x14584D).legacy("Resonant Ender").legacy("Active Enderium");
        builder.activeRecipe((int)activeCoolingRates.getDouble(9), "cryotheum", "Molten Cryotheum", builder.atLeast(2, FuelCellModule::new)).texture(TextureManager.MOLTEN, 0x0099C1).legacy("Gelid Cryotheum").legacy("Active Cryotheum");
        builder.activeRecipe((int)activeCoolingRates.getDouble(10), "iron", "Molten Iron", builder.atLeast(1, gold)).texture(TextureManager.MOLTEN, 0x8D1515).legacy("Molten Iron").legacy("Active Iron");
        builder.activeRecipe((int)activeCoolingRates.getDouble(11), "emerald", "Molten Emerald", builder.atLeast(1, ModeratorModule::new), builder.atLeast(1, FuelCellModule::new)).texture(TextureManager.MOLTEN, 0x51D975).legacy("Molten Emerald").legacy("Active Emerald");
        builder.activeRecipe((int)activeCoolingRates.getDouble(12), "copper", "Molten Copper", builder.atLeast(1, glowstone)).texture(TextureManager.MOLTEN, 0x5C2F1A).legacy("Molten Copper").legacy("Active Copper");
        builder.activeRecipe((int)activeCoolingRates.getDouble(13), "tin", "Molten Tin", builder.axis(lapis)).texture(TextureManager.MOLTEN, 0xD9DDF0).legacy("Molten Tin").legacy("Active Tin");
        builder.activeRecipe((int)activeCoolingRates.getDouble(14), "magnesium", "Molten Magnesium", builder.atLeast(1, CasingModule::new), builder.atLeast(1, ModeratorModule::new)).texture(TextureManager.MOLTEN, 0xEED5E1).legacy("Molten Magnesium").legacy("Active Magnesium");
