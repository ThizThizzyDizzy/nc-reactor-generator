...
public class OverhaulNCConfigReader implements FormatReader{
    ...
    public synchronized Project read(InputStream in, RecoveryHandler recovery){
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulSFR.BlockElement cell = overhaulSFR.cell("nuclearcraft:solid_fission_cell", "Fuel Cell", "overhaul/cell");
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulSFR.BlockElement irradiator = overhaulSFR.irradiator("nuclearcraft:fission_irradiator", "Neutron Irradiator", "overhaul/irradiator");
