...
public class OverhaulNCConfigReader implements FormatReader{
    ...
    public synchronized Project read(InputStream in, RecoveryHandler recovery){
        ...
        overhaulSFR.controller("nuclearcraft:solid_fission_controller", "Solid Fission Controller", "overhaul/controller");
        overhaulSFR.casing("nuclearcraft:fission_casing", "Reactor Casing", "overhaul/casing", true);
        overhaulSFR.casing("nuclearcraft:fission_glass", "Reactor Glass", "overhaul/glass", false);
        ...
        overhaulSFR.source("nuclearcraft:fission_source:0", "Ra-Be Neutron Source", "overhaul/ra-be", (float) sourceEfficiency.getDouble(0));
        overhaulSFR.source("nuclearcraft:fission_source:1", "Po-Be Neutron Source", "overhaul/po-be", (float) sourceEfficiency.getDouble(1));
        overhaulSFR.source("nuclearcraft:fission_source:2", "Cf-252 Neutron Source", "overhaul/cf-252", (float) sourceEfficiency.getDouble(2));
        ...
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:0", "Water Heat Sink", coolingRates.getInt(0), "overhaul/water", rules.getString(0));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:1", "Iron Heat Sink", coolingRates.getInt(1), "overhaul/iron", rules.getString(1));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:2", "Redstone Heat Sink", coolingRates.getInt(2), "overhaul/redstone", rules.getString(2));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:3", "Quartz Heat Sink", coolingRates.getInt(3), "overhaul/quartz", rules.getString(3));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:4", "Obsidian Heat Sink", coolingRates.getInt(4), "overhaul/obsidian", rules.getString(4));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:5", "Nether Brick Heat Sink", coolingRates.getInt(5), "overhaul/nether brick", rules.getString(5));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:6", "Glowstone Heat Sink", coolingRates.getInt(6), "overhaul/glowstone", rules.getString(6));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:7", "Lapis Heat Sink", coolingRates.getInt(7), "overhaul/lapis", rules.getString(7));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:8", "Gold Heat Sink", coolingRates.getInt(8), "overhaul/gold", rules.getString(8));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:9", "Prismarine Heat Sink", coolingRates.getInt(9), "overhaul/prismarine", rules.getString(9));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:10", "Slime Heat Sink", coolingRates.getInt(10), "overhaul/slime", rules.getString(10));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:11", "End Stone Heat Sink", coolingRates.getInt(11), "overhaul/end stone", rules.getString(11));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:12", "Purpur Heat Sink", coolingRates.getInt(12), "overhaul/purpur", rules.getString(12));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:13", "Diamond Heat Sink", coolingRates.getInt(13), "overhaul/diamond", rules.getString(13));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:14", "Emerald Heat Sink", coolingRates.getInt(14), "overhaul/emerald", rules.getString(14));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink:15", "Copper Heat Sink", coolingRates.getInt(15), "overhaul/copper", rules.getString(15));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:0", "Tin Heat Sink", coolingRates.getInt(16), "overhaul/tin", rules.getString(16));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:1", "Lead Heat Sink", coolingRates.getInt(17), "overhaul/lead", rules.getString(17));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:2", "Boron Heat Sink", coolingRates.getInt(18), "overhaul/boron", rules.getString(18));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:3", "Lithium Heat Sink", coolingRates.getInt(19), "overhaul/lithium", rules.getString(19));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:4", "Magnesium Heat Sink", coolingRates.getInt(20), "overhaul/magnesium", rules.getString(20));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:5", "Manganese Heat Sink", coolingRates.getInt(21), "overhaul/manganese", rules.getString(21));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:6", "Aluminum Heat Sink", coolingRates.getInt(22), "overhaul/aluminum", rules.getString(22));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:7", "Silver Heat Sink", coolingRates.getInt(23), "overhaul/silver", rules.getString(23));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:8", "Fluorite Heat Sink", coolingRates.getInt(24), "overhaul/fluorite", rules.getString(24));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:9", "Villiaumite Heat Sink", coolingRates.getInt(25), "overhaul/villiaumite", rules.getString(25));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:10", "Carobbiite Heat Sink", coolingRates.getInt(26), "overhaul/carobbiite", rules.getString(26));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:11", "Arsenic Heat Sink", coolingRates.getInt(27), "overhaul/arsenic", rules.getString(27));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:12", "Liquid Nitrogen Heat Sink", coolingRates.getInt(28), "overhaul/nitrogen", rules.getString(28));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:13", "Liquid Helium Heat Sink", coolingRates.getInt(29), "overhaul/helium", rules.getString(29));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:14", "Enderium Heat Sink", coolingRates.getInt(30), "overhaul/enderium", rules.getString(30));
        overhaulSFR.heatsink("nuclearcraft:solid_fission_sink2:15", "Cryotheum Heat Sink", coolingRates.getInt(31), "overhaul/cryotheum", rules.getString(31));
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulSFR.Block cell = overhaulSFR.cell("nuclearcraft:solid_fission_cell", "Fuel Cell", "overhaul/cell");
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulSFR.Block irradiator = overhaulSFR.irradiator("nuclearcraft:fission_irradiator", "Neutron Irradiator", "overhaul/irradiator");
        ...
        overhaulSFR.conductor("nuclearcraft:fission_conductor", "Conductor", "overhaul/conductor");
        ...
        overhaulSFR.moderator("nuclearcraft:ingot_block:8", "Graphite Moderator", "overhaul/graphite", fluxFac.getInt(0), (float) modEff.getDouble(0));
        overhaulSFR.moderator("nuclearcraft:ingot_block:9", "Beryllium Moderator", "overhaul/beryllium", fluxFac.getInt(1), (float) modEff.getDouble(1));
        overhaulSFR.moderator("nuclearcraft:heavy_water_moderator", "Heavy Water Moderator", "overhaul/heavy water", fluxFac.getInt(2), (float) modEff.getDouble(2));
        ...
        overhaulSFR.reflector("nuclearcraft:fission_reflector:0", "Beryllium-Carbon Reflector", "overhaul/beryllium-carbon", (float) refEff.getDouble(0), (float) refRef.getDouble(0));
        overhaulSFR.reflector("nuclearcraft:fission_reflector:1", "Lead-Steel Reflector", "overhaul/lead-steel", (float) refEff.getDouble(1), (float) refRef.getDouble(1));
        ...
        overhaulSFR.shield("nuclearcraft:fission_shield:0", "Boron-Silver Neutron Shield", "overhaul/boron-silver", "overhaul/boron-silver_closed", (int) shieldHeat.getDouble(0), (float) shieldEff.getDouble(0));
        ...
        IrradiatorRecipe irrec1 = overhaulSFR.irradiatorRecipe("nuclearcraft:dust:3", "Thorium Dust", "overhaul/item/thorium_dust", "nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", (float)irrEff.getDouble(0), (float)irrHeat.getDouble(0));
        irrec1.names.legacyNames.add("Thorium to Protactinium-Enriched Thorium");
        IrradiatorRecipe irrec2 = overhaulSFR.irradiatorRecipe("nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", "nuclearcraft:fission_dust:4", "Protactinium-233 Dust", "overhaul/item/protactinium_dust", (float)irrEff.getDouble(1), (float)irrHeat.getDouble(1));
        irrec2.names.legacyNames.add("Protactinium-Enriched Thorium to Protactinium-233");
        IrradiatorRecipe irrec3 = overhaulSFR.irradiatorRecipe("nuclearcraft:fission_dust:0", "Bismuth Dust", "overhaul/item/bismuth_dust", "nuclearcraft:fission_dust:2", "Polonium Dust", "overhaul/item/polonium_dust", (float)irrEff.getDouble(2), (float)irrHeat.getDouble(2));
        irrec3.names.legacyNames.add("Bismuth Dust to Polonium Dust");
        CoolantRecipe coolant1 = overhaulSFR.coolantRecipe("water", "Water", "fluids/water", "high_pressure_steam", "High Pressure Steam", "fluids/hps", 64, 4);
        coolant1.names.legacyNames.add("Water to High Pressure Steam");
        coolant1.names.legacyNames.add("Water to Hight Pressure Steam");
        CoolantRecipe coolant2 = overhaulSFR.coolantRecipe("preheated_water", "Preheated Water", "fluids/preheated_water", "high_pressure_steam", "High Pressure Steam", "fluids/hps", 32, 4);
        coolant2.names.legacyNames.add("Preheated Water to High Pressure Steam");
        coolant2.names.legacyNames.add("Preheated Water to Hight Pressure Steam");
...
//</editor-fold>
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mstandard = overhaulMSR.heater("nuclearcraft:salt_fission_heater:0", "Standard Coolant Heater", "overhaul/msr/standard", rules.getString(0));
        ...
        overhaulMSR.heaterRecipe(mstandard, "nak", "Eutectic NAK Alloy", "overhaul/msr/coolant/nak", "nak_hot", "Hot Eutectic NaK Alloy", "overhaul/msr/coolant/hot/nak", 1, 1, coolingRates.getInt(0)).names.legacyNames.add("Eutectic NaK Alloy");
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block miron = overhaulMSR.heater("nuclearcraft:salt_fission_heater:1", "Iron Coolant Heater", "overhaul/msr/iron", rules.getString(1));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mredstone = overhaulMSR.heater("nuclearcraft:salt_fission_heater:2", "Redstone Coolant Heater", "overhaul/msr/redstone", rules.getString(2));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mquartz = overhaulMSR.heater("nuclearcraft:salt_fission_heater:3", "Quartz Coolant Heater", "overhaul/msr/quartz", rules.getString(3));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mobsidian = overhaulMSR.heater("nuclearcraft:salt_fission_heater:4", "Obsidian Coolant Heater", "overhaul/msr/obsidian", rules.getString(4));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mnetherBrick = overhaulMSR.heater("nuclearcraft:salt_fission_heater:5", "Nether Brick Coolant Heater", "overhaul/msr/nether brick", rules.getString(5));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mglowstone = overhaulMSR.heater("nuclearcraft:salt_fission_heater:6", "Glowstone Coolant Heater", "overhaul/msr/glowstone", rules.getString(6));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mlapis = overhaulMSR.heater("nuclearcraft:salt_fission_heater:7", "Lapis Coolant Heater", "overhaul/msr/lapis", rules.getString(7));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mgold = overhaulMSR.heater("nuclearcraft:salt_fission_heater:8", "Gold Coolant Heater", "overhaul/msr/gold", rules.getString(8));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mprismarine = overhaulMSR.heater("nuclearcraft:salt_fission_heater:9", "Prismarine Coolant Heater", "overhaul/msr/prismarine", rules.getString(9));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mslime = overhaulMSR.heater("nuclearcraft:salt_fission_heater:10", "Slime Coolant Heater", "overhaul/msr/slime", rules.getString(10));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mendStone = overhaulMSR.heater("nuclearcraft:salt_fission_heater:11", "End Stone Coolant Heater", "overhaul/msr/end stone", rules.getString(11));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mpurpur = overhaulMSR.heater("nuclearcraft:salt_fission_heater:12", "Purpur Coolant Heater", "overhaul/msr/purpur", rules.getString(12));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mdiamond = overhaulMSR.heater("nuclearcraft:salt_fission_heater:13", "Diamond Coolant Heater", "overhaul/msr/diamond", rules.getString(13));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block memerald = overhaulMSR.heater("nuclearcraft:salt_fission_heater:14", "Emerald Coolant Heater", "overhaul/msr/emerald", rules.getString(14));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mcopper = overhaulMSR.heater("nuclearcraft:salt_fission_heater:15", "Copper Coolant Heater", "overhaul/msr/copper", rules.getString(15));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mtin = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:0", "Tin Coolant Heater", "overhaul/msr/tin", rules.getString(16));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mlead = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:1", "Lead Coolant Heater", "overhaul/msr/lead", rules.getString(17));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mboron = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:2", "Boron Coolant Heater", "overhaul/msr/boron", rules.getString(18));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mlithium = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:3", "Lithium Coolant Heater", "overhaul/msr/lithium", rules.getString(19));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mmagnesium = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:4", "Magnesium Coolant Heater", "overhaul/msr/magnesium", rules.getString(20));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mmanganese = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:5", "Manganese Coolant Heater", "overhaul/msr/manganese", rules.getString(21));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block maluminum = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:6", "Aluminum Coolant Heater", "overhaul/msr/aluminum", rules.getString(22));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block msilver = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:7", "Silver Coolant Heater", "overhaul/msr/silver", rules.getString(23));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mfluorite = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:8", "Fluorite Coolant Heater", "overhaul/msr/fluorite", rules.getString(24));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mvilliaumite = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:9", "Villiaumite Coolant Heater", "overhaul/msr/villiaumite", rules.getString(25));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mcarobbiite = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:10", "Carobbiite Coolant Heater", "overhaul/msr/carobbiite", rules.getString(26));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block marsenic = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:11", "Arsenic Coolant Heater", "overhaul/msr/arsenic", rules.getString(27));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mnitrogen = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:12", "Liquid Nitrogen Coolant Heater", "overhaul/msr/nitrogen", rules.getString(28));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mhelium = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:13", "Liquid Helium Coolant Heater", "overhaul/msr/helium", rules.getString(29));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block menderium = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:14", "Enderium Coolant Heater", "overhaul/msr/enderium", rules.getString(30));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mcryotheum = overhaulMSR.heater("nuclearcraft:salt_fission_heater2:15", "Cryotheum Coolant Heater", "overhaul/msr/cryotheum", rules.getString(31));
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block vessel = overhaulMSR.vessel("nuclearcraft:salt_fission_vessel", "Fuel Vessel", "overhaul/msr/vessel");
        ...
        net.ncplanner.plannerator.planner.ncpf.configuration.overhaulMSR.Block mirradiator = overhaulMSR.irradiator("nuclearcraft:fission_irradiator", "Neutron Irradiator", "overhaul/irradiator");
        ...
        overhaulMSR.irradiatorRecipe("nuclearcraft:dust:3", "Thorium Dust", "overhaul/item/thorium_dust", "nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", (float)irrEff.getDouble(0), (float)irrHeat.getDouble(0)).names.legacyNames.add("Thorium to Protactinium-Enriched Thorium");
        overhaulMSR.irradiatorRecipe("nuclearcraft:fission_dust:3", "Protactinium-Enriched Thorium Dust", "overhaul/item/protactinium_enriched_thorium_dust", "nuclearcraft:fission_dust:4", "Protactinium-233 Dust", "overhaul/item/protactinium_dust", (float)irrEff.getDouble(1), (float)irrHeat.getDouble(1)).names.legacyNames.add("Protactinium-Enriched Thorium to Protactinium-233");
        overhaulMSR.irradiatorRecipe("nuclearcraft:fission_dust:0", "Bismuth Dust", "overhaul/item/bismuth_dust", "nuclearcraft:fission_dust:2", "Polonium Dust", "overhaul/item/polonium_dust", (float)irrEff.getDouble(2), (float)irrHeat.getDouble(2)).names.legacyNames.add("Bismuth Dust to Polonium Dust");
