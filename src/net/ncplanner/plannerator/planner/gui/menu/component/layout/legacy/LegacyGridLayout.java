...
public class LegacyGridLayout extends Component{
    private final float componentHeight;
    private final int columns;
    public LegacyGridLayout(float componentHeight, int columns){
        this.componentHeight = componentHeight;
        this.columns = columns;
    }
    public LegacyGridLayout addAll(Iterable<? extends Component> components){
