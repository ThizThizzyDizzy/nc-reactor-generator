...
public class VRMenuComponentOverhaulMSRBlockRecipe extends VRMenuComponent{
    ...
    public VRMenuComponentOverhaulMSRBlockRecipe(VRMenuEdit editor, int id, float x, float y, float z, float width, float height, float depth, Block block, BlockRecipe recipe, int recipeID){
