...
public class MenuModerateError extends Menu{
    ...
    public MenuModerateError(GUI gui, simplelibrary.opengl.gui.Menu menu, String message, Throwable error, ErrorCategory category){
        super(gui, menu);
        String details = "";
        Throwable t = error;
        while(t!=null){
        ...
        scroller.add(new MenuComponentTextDisplay("Moderate "+Character.toUpperCase(category.toString().charAt(0))+category.toString().substring(1)+" Error: "+message+"\n\n"+details));
