...
public class MenuComponentFusionBreedingBlanketRecipe extends MenuComponent{
    public final BreedingBlanketRecipe recipe;
    public MenuComponentFusionBreedingBlanketRecipe(BreedingBlanketRecipe recipe){
        super(0, 0, 0, 0);
        this.recipe = recipe;
    }
    @Override
