...
public class MenuComponentSFRToggleIrradiatorRecipe extends MenuComponent{
    public final IrradiatorRecipe irradiatorRecipe;
    public boolean enabled = false;
    public int min = 0;
    public int max = 0;
    public MenuComponentSFRToggleIrradiatorRecipe(IrradiatorRecipe irradiatorRecipe){
        super(0, 0, 0, 32);
    ...
    public void render(){
        ...
        drawText(irradiatorRecipe.name);
    }
