...
public class MenuComponentFusionToggleBreedingBlanketRecipe extends MenuComponent{
    public final BreedingBlanketRecipe breedingBlanketRecipe;
    public boolean enabled = false;
    public int min = 0;
    public int max = 0;
    public MenuComponentFusionToggleBreedingBlanketRecipe(BreedingBlanketRecipe breedingBlanketRecipe){
        super(0, 0, 0, 32);
    ...
    public void render(){
        ...
        drawText(breedingBlanketRecipe.name);
    }
