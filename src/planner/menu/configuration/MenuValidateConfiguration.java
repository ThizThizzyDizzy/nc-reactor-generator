...
public class MenuValidateConfiguration extends ConfigurationMenu{
    ...
    public Validator validator = new Validator() {
        ...
        public void message(Validator.ValidatorMessage message){
            ...
            MenuComponentLabel lbl = list.add(new MenuComponentLabel(0, 0, 0, 32, message.message, true).setTextColor(() -> {
                return message.color;
            }).setTooltip(tooltip));
            if(message.solveFunc!=null){
                MenuComponentMinimalistButton button = lbl.add(new MenuComponentMinimalistButton(0, 0, lbl.height*4, lbl.height, "Solve", true, true){
                    @Override
    ...
    private final MenuComponentLabel label;
    ...
    public MenuValidateConfiguration(GUI gui, Menu parent, Configuration configuration){
        ...
        label = add(new MenuComponentLabel(sidebar.width, 0, 0, 48, "Validating..."));
        list = add(new MenuComponentMinimaList(sidebar.width, label.height, 0, 0, 32));
    }
    @Override
        ...
        Thread t = new Thread(() -> {
            ...
            if(configuration.underhaul!=null){
                ...
                if(underhaul.fissionSFR==null){
                    ...
                    multiblock.configuration.underhaul.fissionsfr.FissionSFRConfiguration sfr = underhaul.fissionSFR;
                    ...
                    for(int i = 0; i<sfr.blocks.size(); i++){
                        ...
                        multiblock.configuration.underhaul.fissionsfr.Block b = sfr.blocks.get(i);
                        Runnable blockConfig = () -> {
                            gui.open(new planner.menu.configuration.underhaul.fissionsfr.MenuBlockConfiguration(gui, this, configuration, b));
                        };
                        ...
                        if(b.name==null){
                            ...
                            for(multiblock.configuration.underhaul.fissionsfr.Block b2 : sfr.blocks){
                                if(b==b2)continue;
                        ...
                        for(Configuration c : Configuration.configurations){
                            if(c.underhaul!=null&&c.underhaul.fissionSFR!=null){
                                for(multiblock.configuration.underhaul.fissionsfr.Block b2 : c.underhaul.fissionSFR.blocks){
                        ...
                        for(AddonConfiguration c : Configuration.internalAddonCache.values()){
                            if(c.self.underhaul!=null&&c.self.underhaul.fissionSFR!=null){
                                for(multiblock.configuration.underhaul.fissionsfr.Block b2 : c.self.underhaul.fissionSFR.blocks){
                    ...
                    for(int i = 0; i<sfr.fuels.size(); i++){
                        ...
                        multiblock.configuration.underhaul.fissionsfr.Fuel f = sfr.fuels.get(i);
                        Runnable fuelConfig = () -> {
                            gui.open(new planner.menu.configuration.underhaul.fissionsfr.MenuFuelConfiguration(gui, this, configuration, f));
                        };
                        //<editor-fold defaultstate="collapsed" desc="Name">
                        if(f.name==null){
                            ...
                            for(multiblock.configuration.underhaul.fissionsfr.Fuel f2 : sfr.fuels){
                                if(f==f2)continue;
                        ...
                        for(Configuration c : Configuration.configurations){
                            if(c.underhaul!=null&&c.underhaul.fissionSFR!=null){
                                for(multiblock.configuration.underhaul.fissionsfr.Fuel f2 : c.underhaul.fissionSFR.fuels){
                        ...
                        for(AddonConfiguration c : Configuration.internalAddonCache.values()){
                            if(c.self.underhaul!=null&&c.self.underhaul.fissionSFR!=null){
                                for(multiblock.configuration.underhaul.fissionsfr.Fuel f2 : c.self.underhaul.fissionSFR.fuels){
            ...
            if(configuration.overhaul!=null){
                ...
                if(overhaul.fissionSFR==null&&overhaul.fissionMSR==null&&overhaul.turbine==null&&overhaul.fusion==null){
                    ...
                    if(overhaul.fissionSFR!=null){
                        ...
                        multiblock.configuration.overhaul.fissionsfr.FissionSFRConfiguration sfr = overhaul.fissionSFR;
                        if(configuration.addon){
                            //<editor-fold defaultstate="collapsed" desc="Size">
                        ...
                        for(int i = 0; i<sfr.blocks.size(); i++){
                            validator.stage("Checking blocks... ("+(i+1)+"/"+sfr.blocks.size()+")");
                            multiblock.configuration.overhaul.fissionsfr.Block b = sfr.blocks.get(i);
                            Runnable blockConfig = () -> {
                                gui.open(new planner.menu.configuration.overhaul.fissionsfr.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                                ...
                                for(multiblock.configuration.overhaul.fissionsfr.Block b2 : sfr.blocks){
                                    if(b==b2)continue;
                            ...
                            for(Configuration c : Configuration.configurations){
                                if(c.overhaul!=null&&c.overhaul.fissionSFR!=null){
                                    for(multiblock.configuration.overhaul.fissionsfr.Block b2 : c.overhaul.fissionSFR.blocks){
                                        if(b.name.equals(b2.name)){
                            ...
                            for(AddonConfiguration c : Configuration.internalAddonCache.values()){
                                if(c.self.overhaul!=null&&c.self.overhaul.fissionSFR!=null){
                                    for(multiblock.configuration.overhaul.fissionsfr.Block b2 : c.self.overhaul.fissionSFR.blocks){
                                        if(b.name.equals(b2.name)&&!b.legacyNames.equals(b2.legacyNames)){
                            ...
                            for(multiblock.configuration.overhaul.fissionsfr.BlockRecipe br : b.recipes){
                                Runnable blockRecipeConfig = () -> {
                                    gui.open(new planner.menu.configuration.overhaul.fissionsfr.MenuBlockRecipeConfiguration(gui, this, configuration, b, br));
                                };
                                ...
                                if(br.inputName==null){
                                    ...
                                    for(multiblock.configuration.overhaul.fissionsfr.BlockRecipe c2 : b.recipes){
                                        if(br==c2)continue;
                                ...
                                for(Configuration cf : Configuration.configurations){
                                    if(cf.overhaul!=null&&cf.overhaul.fissionSFR!=null){
                                        for(multiblock.configuration.overhaul.fissionsfr.Block b2 : cf.overhaul.fissionSFR.blocks){
                                ...
                                for(AddonConfiguration cf : Configuration.internalAddonCache.values()){
                                    if(cf.self.overhaul!=null&&cf.self.overhaul.fissionSFR!=null){
                                        for(multiblock.configuration.overhaul.fissionsfr.Block b2 : cf.self.overhaul.fissionSFR.blocks){
                                            if(!b.name.equals(b2.name))continue;
                                            for(multiblock.configuration.overhaul.fissionsfr.BlockRecipe r2 : b2.recipes){
                        ...
                        for(int i = 0; i<sfr.coolantRecipes.size(); i++){
                            ...
                            multiblock.configuration.overhaul.fissionsfr.CoolantRecipe c = sfr.coolantRecipes.get(i);
                            Runnable coolantRecipeConfig = () -> {
                                gui.open(new planner.menu.configuration.overhaul.fissionsfr.MenuCoolantRecipeConfiguration(gui, this, configuration, c));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Input Name">
                            if(c.inputName==null){
                                ...
                                for(multiblock.configuration.overhaul.fissionsfr.CoolantRecipe c2 : sfr.coolantRecipes){
                                    if(c==c2)continue;
                            ...
                            for(Configuration cf : Configuration.configurations){
                                if(cf.overhaul!=null&&cf.overhaul.fissionSFR!=null){
                                    for(multiblock.configuration.overhaul.fissionsfr.CoolantRecipe c2 : cf.overhaul.fissionSFR.coolantRecipes){
                            ...
                            for(AddonConfiguration cf : Configuration.internalAddonCache.values()){
                                if(cf.self.overhaul!=null&&cf.self.overhaul.fissionSFR!=null){
                                    for(multiblock.configuration.overhaul.fissionsfr.CoolantRecipe c2 : cf.self.overhaul.fissionSFR.coolantRecipes){
                    ...
                    if(overhaul.fissionMSR!=null){
                        ...
                        multiblock.configuration.overhaul.fissionmsr.FissionMSRConfiguration msr = overhaul.fissionMSR;
                        if(configuration.addon){
                            //<editor-fold defaultstate="collapsed" desc="Size">
                        ...
                        for(int i = 0; i<msr.blocks.size(); i++){
                            ...
                            multiblock.configuration.overhaul.fissionmsr.Block b = msr.blocks.get(i);
                            Runnable blockConfig = () -> {
                                gui.open(new planner.menu.configuration.overhaul.fissionmsr.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                                ...
                                for(multiblock.configuration.overhaul.fissionmsr.Block b2 : msr.blocks){
                                    if(b==b2)continue;
                            ...
                            for(Configuration c : Configuration.configurations){
                                if(c.overhaul!=null&&c.overhaul.fissionMSR!=null){
                                    for(multiblock.configuration.overhaul.fissionmsr.Block b2 : c.overhaul.fissionMSR.blocks){
                                        if(b.name.equals(b2.name)){
                            ...
                            for(AddonConfiguration c : Configuration.internalAddonCache.values()){
                                if(c.self.overhaul!=null&&c.self.overhaul.fissionMSR!=null){
                                    for(multiblock.configuration.overhaul.fissionmsr.Block b2 : c.self.overhaul.fissionMSR.blocks){
                                        if(b.name.equals(b2.name)&&!b.legacyNames.equals(b2.legacyNames)){
                            ...
                            if(b.irradiator){
                                //<editor-fold defaultstate="collapsed" desc="Block Recipes">
                                for(multiblock.configuration.overhaul.fissionmsr.BlockRecipe br : b.recipes){
                                    Runnable blockRecipeConfig = () -> {
                                        gui.open(new planner.menu.configuration.overhaul.fissionmsr.MenuBlockRecipeConfiguration(gui, this, configuration, b, br));
                                    };
                                    //<editor-fold defaultstate="collapsed" desc="Input Name">
                                    if(br.inputName==null){
                                        ...
                                        for(multiblock.configuration.overhaul.fissionmsr.BlockRecipe c2 : b.recipes){
                                            if(br==c2)continue;
                                    ...
                                    for(Configuration cf : Configuration.configurations){
                                        if(cf.overhaul!=null&&cf.overhaul.fissionMSR!=null){
                                            for(multiblock.configuration.overhaul.fissionmsr.Block b2 : cf.overhaul.fissionMSR.blocks){
                                                if(!b.name.equals(b2.name))continue;
                                    ...
                                    for(AddonConfiguration cf : Configuration.internalAddonCache.values()){
                                        if(cf.self.overhaul!=null&&cf.self.overhaul.fissionMSR!=null){
                                            for(multiblock.configuration.overhaul.fissionmsr.Block b2 : cf.self.overhaul.fissionMSR.blocks){
                                                if(!b.name.equals(b2.name))continue;
                                                for(multiblock.configuration.overhaul.fissionmsr.BlockRecipe r2 : b2.recipes){
                                                    if(br.inputName.equals(r2.inputName)&&!br.inputLegacyNames.equals(r2.inputLegacyNames)){
                    ...
                    if(overhaul.turbine!=null){
                        ...
                        multiblock.configuration.overhaul.turbine.TurbineConfiguration turbine = overhaul.turbine;
                        if(configuration.addon){
                            //<editor-fold defaultstate="collapsed" desc="Size">
                        ...
                        for(int i = 0; i<turbine.blocks.size(); i++){
                            ...
                            multiblock.configuration.overhaul.turbine.Block b = turbine.blocks.get(i);
                            Runnable blockConfig = () -> {
                                gui.open(new planner.menu.configuration.overhaul.turbine.MenuBlockConfiguration(gui, this, configuration, b));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Name">
                            if(b.name==null){
                                ...
                                for(multiblock.configuration.overhaul.turbine.Block b2 : turbine.blocks){
                                    if(b==b2)continue;
                            ...
                            for(Configuration c : Configuration.configurations){
                                if(c.overhaul!=null&&c.overhaul.turbine!=null){
                                    for(multiblock.configuration.overhaul.turbine.Block b2 : c.overhaul.turbine.blocks){
                                        if(b.name.equals(b2.name)){
                            ...
                            for(AddonConfiguration c : Configuration.internalAddonCache.values()){
                                if(c.self.overhaul!=null&&c.self.overhaul.turbine!=null){
                                    for(multiblock.configuration.overhaul.turbine.Block b2 : c.self.overhaul.turbine.blocks){
                                        if(b.name.equals(b2.name)&&!b.legacyNames.equals(b2.legacyNames)){
                        ...
                        for(int i = 0; i<turbine.recipes.size(); i++){
                            ...
                            multiblock.configuration.overhaul.turbine.Recipe c = turbine.recipes.get(i);
                            Runnable recipeConfig = () -> {
                                gui.open(new planner.menu.configuration.overhaul.turbine.MenuRecipeConfiguration(gui, this, configuration, c));
                            };
                            //<editor-fold defaultstate="collapsed" desc="Input Name">
                            if(c.inputName==null){
                                ...
                                for(multiblock.configuration.overhaul.turbine.Recipe c2 : turbine.recipes){
                                    if(c==c2)continue;
                            ...
                            for(Configuration cf : Configuration.configurations){
                                if(cf.overhaul!=null&&cf.overhaul.turbine!=null){
                                    for(multiblock.configuration.overhaul.turbine.Recipe c2 : cf.overhaul.turbine.recipes){
                                        if(c.inputName.equals(c2.inputName)){
                            ...
                            for(AddonConfiguration cf : Configuration.internalAddonCache.values()){
                                if(cf.self.overhaul!=null&&cf.self.overhaul.turbine!=null){
                                    for(multiblock.configuration.overhaul.turbine.Recipe c2 : cf.self.overhaul.turbine.recipes){
                                        if(c.inputName.equals(c2.inputName)&&!c.inputLegacyNames.equals(c2.inputLegacyNames)){
    ...
    @Override
    public void render(int millisSinceLastTick){
        label.width = list.width = gui.helper.displayWidth()-sidebar.width;
    ...
    private void validate(ArrayList<? extends AbstractPlacementRule> rules, String sectionName, Runnable blockCfg){
        for(AbstractPlacementRule rule : rules){
            if(rule.block!=null){
                if(rule.block instanceof multiblock.configuration.underhaul.fissionsfr.Block){
                    multiblock.configuration.underhaul.fissionsfr.Block b = (multiblock.configuration.underhaul.fissionsfr.Block)rule.block;
                ...
                if(rule.block instanceof multiblock.configuration.overhaul.fissionsfr.Block){
                    multiblock.configuration.overhaul.fissionsfr.Block b = (multiblock.configuration.overhaul.fissionsfr.Block)rule.block;
                ...
                if(rule.block instanceof multiblock.configuration.overhaul.fissionmsr.Block){
                    multiblock.configuration.overhaul.fissionmsr.Block b = (multiblock.configuration.overhaul.fissionmsr.Block)rule.block;
                    if(b.parent!=null)validator.error(sectionName+" placement rule "+rule.ruleType.name+" contains a port!").solve(blockCfg, "Go to Block configuration");
                ...
                if(rule.block instanceof multiblock.configuration.overhaul.turbine.Block){
                    multiblock.configuration.overhaul.turbine.Block b = (multiblock.configuration.overhaul.turbine.Block)rule.block;
