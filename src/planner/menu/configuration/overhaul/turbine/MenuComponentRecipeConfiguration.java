...
public class MenuComponentRecipeConfiguration extends MenuComponent{
    ...
    public void renderForeground(){
        Core.applyColor(Core.theme.getTextColor());
        drawText(x, y, x+width, y+height/4, recipe.name);
        drawText(x, y+height/4, x+width, y+height/4*2, "Coefficient: "+recipe.coefficient);
        drawText(x, y+height/4*2, x+width, y+height/4*3, "Power: "+recipe.power);
    }
}