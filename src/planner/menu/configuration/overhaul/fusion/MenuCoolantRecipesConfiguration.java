...
public class MenuCoolantRecipesConfiguration extends Menu{
    ...
    public MenuCoolantRecipesConfiguration(GUI gui, Menu parent, Configuration configuration){
        ...
        add.addActionListener((e) -> {
            ...
            configuration.overhaul.fusion.coolantRecipes.add(b);
            Core.configuration.overhaul.fusion.allCoolantRecipes.add(b);
    ...
    public void onGUIOpened(){
        ...
        for(CoolantRecipe b : configuration.overhaul.fusion.coolantRecipes){
        ...
        for(simplelibrary.opengl.gui.components.MenuComponent c : list.components){
            if(c instanceof MenuComponentCoolantRecipeConfiguration){
                if(button==((MenuComponentCoolantRecipeConfiguration) c).delete){
                    configuration.overhaul.fusion.coolantRecipes.remove(((MenuComponentCoolantRecipeConfiguration) c).coolantRecipe);
                    Core.configuration.overhaul.fusion.allCoolantRecipes.remove(((MenuComponentCoolantRecipeConfiguration) c).coolantRecipe);
                    refreshNeeded = true;
                    return;
                }
