...
public class MenuComponentRecipeConfiguration extends MenuComponent{
    ...
    public void renderForeground(){
        Core.applyColor(Core.theme.getTextColor());
        drawText(x, y, x+width, y+height/5, recipe.name);
        drawText(x, y+height/5, x+width, y+height/5*2, "Efficiency: "+recipe.efficiency);
        drawText(x, y+height/5*2, x+width, y+height/5*3, "Heat: "+recipe.heat);
        drawText(x, y+height/5*3, x+width, y+height/5*4, "Time: "+recipe.time);
        drawText(x, y+height/5*4, x+width, y+height/5*5, "Fluxiness: "+recipe.fluxiness);
    }
}