...
public class MenuComponentBreedingBlanketRecipeConfiguration extends MenuComponent{
    public final BreedingBlanketRecipe breedingBlanketRecipe;
    ...
    }.setTooltip("Modify breeding blanket recipe"));
    ...
    }.setTooltip("Delete breeding blanket recipe\nWARNING: This cannot be undone!"));
    public MenuComponentBreedingBlanketRecipeConfiguration(BreedingBlanketRecipe breedingBlanketRecipe){
        super(0, 0, 0, 100);
    ...
    public void renderForeground(){
        Core.applyColor(Core.theme.getTextColor());
        drawText(x, y, x+width, y+height/4, breedingBlanketRecipe.name);
        drawText(x, y+height/4, x+width, y+height/4*2, "Efficiency: "+breedingBlanketRecipe.efficiency);
        drawText(x, y+height/4*2, x+width, y+height/4*3, "Heat: "+breedingBlanketRecipe.heat);
    }
}