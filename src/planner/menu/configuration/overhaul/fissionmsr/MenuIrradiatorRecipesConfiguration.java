...
public class MenuIrradiatorRecipesConfiguration extends Menu{
    ...
    public MenuIrradiatorRecipesConfiguration(GUI gui, Menu parent){
        ...
        add.addActionListener((e) -> {
            ...
            Core.configuration.overhaul.fissionMSR.irradiatorRecipes.add(b);
    ...
    public void onGUIOpened(){
        ...
        for(IrradiatorRecipe b : Core.configuration.overhaul.fissionMSR.irradiatorRecipes){
        ...
        for(MenuComponent c : list.components){
            if(c instanceof MenuComponentIrradiatorRecipeConfiguration){
                if(button==((MenuComponentIrradiatorRecipeConfiguration) c).delete){
                    Core.configuration.overhaul.fissionMSR.irradiatorRecipes.remove(((MenuComponentIrradiatorRecipeConfiguration) c).irradiatorRecipe);
                    refreshNeeded = true;
                    return;
                }
