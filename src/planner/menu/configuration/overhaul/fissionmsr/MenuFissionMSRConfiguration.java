...
public class MenuFissionMSRConfiguration extends Menu{
    ...
    public void render(int millisSinceLastTick){
        ...
        blocks.width = fuels.width = sources.width = irradiatorRecipes.width = back.width = gui.helper.displayWidth();
        minSize.height = maxSize.height = neutronReach.height = coolingEfficiencyLeniency.height = sparsityPenaltyMult.height = sparsityPenaltyThreshold.height = blocks.height = fuels.height = sources.height = irradiatorRecipes.height = back.height = gui.helper.displayHeight()/16;
