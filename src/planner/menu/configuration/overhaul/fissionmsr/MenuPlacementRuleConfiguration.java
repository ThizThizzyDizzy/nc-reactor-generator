...
public class MenuPlacementRuleConfiguration extends Menu{
    ...
    private final MenuComponentMinimalistOptionButton block = add(new MenuComponentMinimalistOptionButton(0, 0, 0, 0, "Block", true, true, 0, Core.configuration.overhaul.fissionMSR.getAllBlocksStringList()));
    ...
    public void onGUIOpened(){
        ...
        block.setIndex(rule.block==null?0:Core.configuration.overhaul.fissionMSR.allBlocks.indexOf(rule.block));
    ...
    public void onGUIClosed(){
        ...
        rule.block = Core.configuration.overhaul.fissionMSR.allBlocks.get(block.getIndex());
