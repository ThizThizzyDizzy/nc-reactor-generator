...
public class MenuBlockConfiguration extends Menu{
    ...
    public void render(int millisSinceLastTick){
        ...
        functional.height = blocksLOS.height = heatMult.height = reflectivity.height = efficiency.height = flux.height = shield.height = activeModerator.height = moderator.height = irradiator.height = reflector.height = fuelVessel.height = conductor.height = createCluster.height = cluster.height = cooling.height = name.height = rules.height = back.height = Display.getHeight()/20;
