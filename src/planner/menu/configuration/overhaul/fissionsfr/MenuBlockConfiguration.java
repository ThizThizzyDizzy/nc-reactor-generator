...
public class MenuBlockConfiguration extends Menu{
    ...
    public void render(int millisSinceLastTick){
        ...
        texture.x = texture.height = functional.height = blocksLOS.height = heatMult.height = reflectivity.height = efficiency.height = flux.height = shield.height = activeModerator.height = moderator.height = irradiator.height = reflector.height = fuelCell.height = conductor.height = createCluster.height = cluster.height = cooling.height = name.height = rules.height = back.height = Display.getHeight()/numComps;
        ...
        drawText(0, Display.getHeight()/numComps*12, Display.getWidth()*.25, Display.getHeight()/numComps*13, "Neutron Flux");
        drawText(0, Display.getHeight()/numComps*13, Display.getWidth()*.25, Display.getHeight()/numComps*14, "Efficiency");
        drawText(0, Display.getHeight()/numComps*14, Display.getWidth()*.25, Display.getHeight()/numComps*15, "Reflectivity");
        drawText(0, Display.getHeight()/numComps*15, Display.getWidth()*.25, Display.getHeight()/numComps*16, "Heat Multiplier");
        Core.applyWhite();
