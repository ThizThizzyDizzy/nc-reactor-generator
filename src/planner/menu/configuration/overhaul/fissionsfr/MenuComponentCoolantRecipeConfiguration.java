...
public class MenuComponentCoolantRecipeConfiguration extends MenuComponent{
    ...
    public MenuComponentCoolantRecipeConfiguration(CoolantRecipe coolantRecipe){
        super(0, 0, 0, 100);
    ...
    public void renderForeground(){
        Core.applyColor(Core.theme.getTextColor());
        drawText(x, y, x+width, y+height/4, coolantRecipe.name);
        drawText(x, y+height/4, x+width, y+height/4*2, "Heat: "+coolantRecipe.heat);
        drawText(x, y+height/4*2, x+width, y+height/4*3, "Output Ratio: "+coolantRecipe.outputRatio);
    }
}