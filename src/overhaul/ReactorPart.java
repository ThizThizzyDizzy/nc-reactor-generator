...
public class ReactorPart implements ReactorBit{
    ...
    public static final Heatsink HEATSINK_GOLD = heatsink("Gold", "Gold", PlacementRule.exactly(2, HEATSINK_IRON));
    ...
    public static final Heatsink HEATSINK_PURPUR = heatsink("Purpur", "Purpur", PlacementRule.atLeast(1, HEATSINK_IRON), PlacementRule.atLeast(1, Type.REFLECTOR));
    ...
    public static final Heatsink HEATSINK_LITHIUM = heatsink("Lithium", "Lithium", PlacementRule.exactly(2, HEATSINK_LEAD), PlacementRule.axis(HEATSINK_LEAD), PlacementRule.atLeast(1, Type.CASING));
